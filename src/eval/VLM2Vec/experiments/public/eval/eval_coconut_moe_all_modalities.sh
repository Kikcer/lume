...
CHECKPOINT="${CHECKPOINT:-$UME_ROOT/output/PLUME/PLUME-NoAns-6latent-8node-moe-2epoch2026-03-21-00-52-25-2/checkpoint-2862}"
...
OUTPUT_BASEDIR="${OUTPUT_BASEDIR:-$UME_ROOT/output/Eval/UME-R1_2B_MoE}"
...
FORCE_REEVAL="${FORCE_REEVAL:-True}"
