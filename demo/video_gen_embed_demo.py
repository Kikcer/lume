...
messages = [
    {
        ...
        "content": [
            {
                "type": "video",
                "video": "VLM-R1/src/eval/VLM2Vec/assets/example_video.mp4",
            },
...
print(processor.tokenizer.get_vocab()["<gen_emb>"])
...
pos_messages = [
    {
        "role": "user",
        "content": [
            {"type": "text", "text": "A man in a gray sweater plays fetch with his dog in the snowy yard, throwing a toy and watching it run.\n<disc_emb>\n" + prompt},
        ],
    }
]
...
neg_messages = [
    {
        "role": "user",
        "content": [
            {"type": "text", "text": "A person dressed in a blue jacket shovels the snow-covered pavement outside their house.\n<disc_emb>\n" + prompt},
        ],
    }
]
# Preparation for inference
